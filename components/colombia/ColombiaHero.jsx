...
import { COLOMBIA_ASTRONAUT_SRC, COLOMBIA_WA_HREF } from '@/lib/colombia/brand';
import colombiaVibrant from './colombiaVibrant.module.css';
import styles from './ColombiaHero.module.css';
...
export default function ColombiaHero() {
  ...
  return (
    <section className={styles.hero} id="inicio" aria-label="Inicio">
      ...
      <div className={styles.content}>
        ...
        >
          <motion.p className={`${styles.label} ${colombiaVibrant.labelCaps}`} variants={fadeUp}>
            Fluxa Method — Arquitectura digital
          </motion.p>
          <motion.h1 className={`${styles.title} ${colombiaVibrant.headlineHero}`} variants={fadeUp}>
            <span className={styles.titleLine}>Tu visión convertida</span>
            <span className={colombiaVibrant.accentPurple}>en tecnología que funciona sola.</span>
          </motion.h1>
