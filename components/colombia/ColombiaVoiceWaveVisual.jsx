import blockStyles from './ColombiaServiceBlocks.module.css';
import styles from './ColombiaVoiceWaveVisual.module.css';
...
export default function ColombiaVoiceWaveVisual() {
  return (
    <div
