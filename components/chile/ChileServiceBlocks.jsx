...
function ServiceImagePlaceholder({ blockId }) {
  return (
    <div
      className={`service-image-placeholder service-block-${blockId} ${chileVibrant.glowPanel} ${styles.imagePlaceholder}`}
    >
...
function ServiceBlockStaticImage({ blockId, src, alt }) {
  return (
    <div
      className={`service-block-${blockId} ${chileVibrant.glowPanel} ${styles.blockImagePanel} ${styles.blockImagePanelTight}`}
    >
      <Image
        src={src}
        alt={alt}
...
function ServiceBlock5Video() {
  return (
    <div
      className={`service-block-5 ${chileVibrant.glowPanel} ${styles.blockImagePanel} ${styles.blockImagePanelTight} ${styles.blockVideoPanel}`}
    >
      <video
        className={styles.blockVideo}
        src={CHILE_DASHBOARD_VIDEO_SRC}
        autoPlay
        muted
        loop
        playsInline
...
function ServiceBlock1Creative() {
  return (
    <div className={`service-block-1 ${chileVibrant.glowPanel} ${styles.blockVitrina}`}>
...
function ServiceBlockText({ block }) {
  return (
    <div className={styles.textCol}>
      <p className={`${styles.label} ${chileVibrant.labelCaps}`}>{block.label}</p>
      <h3 className={`${styles.blockTitle} ${chileVibrant.headlineBlock}`}>{block.title}</h3>
    ...
    <div className={styles.blockInnerIA}>
      <div className={styles.textColIA}>
        ...
        <div className={styles.iaListRow}>
          ...
          <Image
            src={CHILE_AUTOMATIZACIONES_SRC}
...
export default function ChileServiceBlocks() {
  const reduceMotion = useReducedMotion();

  return (
    <ChileSection className={styles.section} id="catalogo">
      <div className={styles.sectionHead}>
        <h2 className={`${styles.h2} ${chileVibrant.headlineSm}`}>
          ¿Qué <span className={chileVibrant.accentPurple}>construimos</span>?
        </h2>
        <p className={`${styles.sub} ${chileVibrant.body}`}>
          Arquitectura digital por categorías —{' '}
          <span className={chileVibrant.accentCyan}>todo a medida</span>.
        </p>
      </div>
