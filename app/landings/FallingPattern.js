...
import styles from './fallingPattern.module.css';
...
export function FallingPattern(props) {
  var color = props.color != null ? props.color : 'rgba(124, 58, 237, 0.4)';
  var backgroundColor = props.backgroundColor != null ? props.backgroundColor : '#0a0a0a';
  var duration = props.duration != null ? props.duration : 150;
  var blurIntensity = props.blurIntensity != null ? props.blurIntensity : '1em';
  ...
  return (
    <div className={joinClass(styles.root, className)}>
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
